...
import SlapL from './slap-l'
import SlapR from './slap-r'
import './header.css'

const Header = (props) => {
  return (
    <div className={`header-hero ${props.rootClassName} `}>
      <div className="header-container">
        <header data-role="Header" className="header-header">
          <a
            href="https://www.colombiandevs.com"
            target="_blank"
        ...
        <div className="header-container2">
          <SlapL rootClassName="slap-l-root-class-name" className=""></SlapL>
          <SlapR rootClassName="slap-r-root-class-name" className=""></SlapR>
        </div>
      </div>
    </div>
  )
